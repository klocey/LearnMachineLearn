...
def get_model_instance_segmentation(num_classes):
    ...
    '''
    a function to allow model to be trained and evaluated on a custom dataset
    '''
...
def get_transforms(train):
    ...
    '''
    a helper function to perform the training and evaluation
    '''
    transforms = []
...
def main():
    # train one the GPU or on the CPU, if a GPU is not available
    ...
    lr_schedular = torch.optim.lr_schedulaer.StepLR(optimizer,
                                                    step_size=3,
                                                    gamma=0.1)
